...
args={"images":"G:/Xue-Mountain-Enterance",
      "output":"G:/Xue-Mountain-Enterance/output.png",
      "crop":1}
...
stitcher = cv2.createStitcher(cv2.Stitcher_PANORAMA) if imutils.is_cv3() else cv2.Stitcher_create()
...
if status == 0:
	...
	# cv2.resizeWindow("resized", 10000, 200);
	cv2.imshow("resized", stitched)
	cv2.waitKey(0)
